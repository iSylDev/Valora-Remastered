...
const SectionHeader = ({ title, description, buttonText = 'See All' }: { title: string, description: string, buttonText?: string }) => {
  return (
    <div className="mb-9 flex flex-col lg:flex-row lg:justify-center text-center lg:text-left">
      <h3 className="text-3xl font-semibold mb-2 lg:w-full lg:text-5xl lg:text-left">{title}</h3>
      <div>
